...
import { CoffeeIcon, WalletIcon } from '../components/Icons';
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        >
          ...
          <div>
            ...
            <p className="text-slate-500 mt-2">Buy me a coffee to fuel the late night coding sessions.</p>
          </div>
        ...
        >
          <div className="w-20 h-20 bg-blue-600 rounded-3xl flex items-center justify-center text-white shadow-xl group-hover:rotate-6 transition-transform">
            <svg className="w-10 h-10" fill="currentColor" viewBox="0 0 24 24"><path d="M7.076 21.337H2.47a.641.641 0 0 1-.633-.74L4.944 3.723a1.603 1.603 0 0 1 1.582-1.337h7c3.754 0 6.41 1.533 5.405 5.896-.65 3.123-3.085 4.71-5.744 4.71H10.19l-1.34 5.61a.641.641 0 0 0 .626.735zM12.912 2.386H5.912a.641.641 0 0 0-.633.535l-3.107 16.87a.641.641 0 0 0 .633.74h4.606a.641.641 0 0 0 .626-.535l1.34-5.61h3.003c2.659 0 5.094-1.587 5.744-4.71 1.005-4.363-1.65-5.896-5.405-5.896z" /></svg>
          </div>
          <div>
            <h3 className="text-2xl font-bold text-slate-900">PayPal</h3>
            <p className="text-slate-500 mt-2">Fast and secure global transfers for international supporters.</p>
          </div>
        ...
        >
          ...
          <div>
            ...
            <p className="text-slate-500 mt-2">Preferred option for supporters in Africa and via M-Pesa.</p>
          </div>
